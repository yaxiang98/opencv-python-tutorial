...
titles = ['iamge', 'Laplacian (Default Kernal Size = 1)', 'Laplacian (Kernal Size = 3)', 'Laplacian (Kernal Size = 5)', 'SobelX', 'SobelY', 'Sobel X and Y Combined', 'Sobel X and Y Combined Inv', 'Canny']
images = [img, lap, lap_k3, lap_k5, sobelX, sobelY, SobelCombined, SobelCombined_inv, canny]
...
# As of the result, Canny Edge Detection present less noise
# you got more precise edges with less noise when using Canny